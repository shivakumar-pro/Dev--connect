    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers("/api/bottle/**").permitAll()
                .requestMatchers("/api/toxic/**").permitAll()
                .requestMatchers(HttpMethod.GET, "/api/chowka/rooms").permitAll()
                .requestMatchers(HttpMethod.GET, "/api/chowka/rooms/*").permitAll()
                .requestMatchers(HttpMethod.GET, "/api/leaderboard").permitAll()
                .requestMatchers(HttpMethod.GET, "/api/stats/*").permitAll()
                .requestMatchers(HttpMethod.GET, "/api/phase10/rooms").permitAll()
                .requestMatchers(HttpMethod.GET, "/api/phase10/room/*").permitAll()
                .requestMatchers(HttpMethod.GET, "/api/phase10/phases").permitAll()
                .requestMatchers(HttpMethod.GET, "/api/phase10/leaderboard").permitAll()
                .requestMatchers(HttpMethod.GET, "/api/phase10/stats/*").permitAll()
